...
void main() {
  test('Calculate different empty ', () {
    expect(SnackyDurationUtil.calculateDuration('', null), const Duration(seconds: 5));
    expect(SnackyDurationUtil.calculateDuration('', ''), const Duration(seconds: 5));
    expect(SnackyDurationUtil.calculateDuration('', '1'), const Duration(seconds: 6));
    expect(SnackyDurationUtil.calculateDuration('1', '1'), const Duration(seconds: 6));
    expect(SnackyDurationUtil.calculateDuration('1', ''), const Duration(seconds: 6));
    expect(SnackyDurationUtil.calculateDuration('1', null), const Duration(seconds: 6));
  });
  ...
  test('Calculate different long snackies (120 chars)', () {
    ...
    expect(SnackyDurationUtil.calculateDuration(longText, ''), const Duration(seconds: 6));
    expect(SnackyDurationUtil.calculateDuration('', longText), const Duration(seconds: 6));
  });
  test('Calculate different long snackies (121 chars)', () {
    ...
    expect(SnackyDurationUtil.calculateDuration(longText, ''), const Duration(seconds: 7));
    expect(SnackyDurationUtil.calculateDuration('', longText), const Duration(seconds: 7));
  });
  ...
  test('Calculate different long snackies (exactly max length)', () {
    ...
    expect(SnackyDurationUtil.calculateDuration(longText, ''), const Duration(seconds: 30));
    expect(SnackyDurationUtil.calculateDuration('', longText), const Duration(seconds: 30));
  });
